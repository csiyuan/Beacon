...
export default function Hero() {
  ...
  return (
    <section className={s.hero} data-hover={hover ?? 'none'}>
      ...
      <link rel="preload" as="video" href="/assets/beacon-creative-transition.mp4" />
      <link rel="preload" as="video" href="/assets/beacon-brand-transition.mp4" />
      <link rel="preload" as="video" href="/assets/beacon-creative-landing-page-entry.mp4" />
      ...
      <div className={s.heroImageWrap}>
        <Image
          src="/assets/beacon-landing-page.png"
          alt=""
          fill
          priority
          sizes="100vw"
      ...
      <div className={s.overlay}>
        ...
        <nav className={s.heroNav}>
          ...
          >
            <span className={s.heroLogoArrow} aria-hidden="true">
          ...
          <div className={s.heroNavLinks}>
            <Link href="/brands?from=splash" className={s.heroNavLink}>For Brands</Link>
            <Link href="/creatives/embedded" className={s.heroNavLink}>For Creatives</Link>
            <Link href="/about?from=splash" className={s.heroNavLink}>About</Link>
            <Link href="/contact?from=splash" className={s.heroNavLink}>Contact</Link>
          </div>
        </nav>
